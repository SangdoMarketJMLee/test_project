...
# 문제 2 (10점)
def data_type(_int, _float, _string, _list, _dict,_tuple):

    print(type(_int),type(_float),type(_string),type(_list),type(_dict))



print("2번 답안")   
print(data_type(1,1.1,'안녕',[1,2,3],{1:2, 2:"2"},(1,2,3)))
